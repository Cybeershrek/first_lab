...
const char* error_to_string(StringErrors error) {
    switch (error) {
        ...
        case SHIFT_IS_TOO_BIG: return "Сдвиг слишком большой для данной строки";
        case SHIFT_DOESNT_EXIST: return "сдвига не существует";
...
int outputting(){
    ...
    while (1) {
        ...
        printf("6. Является строкаполиндромом\n");
        printf("7. Пояснения операций\n");
        printf("0. Выход\n");
        printf("Ваш выбор: ");
        scanf("%d", &choice);
        getchar();
        ...
        switch (choice) {
            ...
            case 2:
                ...
                fgets(str1, 256, stdin);
                str1[strcspn(str1, "\n")] = '\0';
                printf("Введите величену сдвига: ");
                int shi;
                scanf("%d", &shi);
                ...
                error = recoding(mstr1, &shi, moutput);
                if (error == STRING_OPERATION_OK) {
                    printf("Результат: %s\n", (char*)moutput->data);
                } else {
                    printf("Ошибка операции: %s\n", error_to_string(error));
            ...
            case 4:
                ...
                if (error == STRING_OPERATION_OK && parts) {
            ...
            case 6: 
                ...
                error = is_palindrome(mstr1, &found);
                if (error == STRING_OPERATION_OK) {
            ...
            case 7:
                ...
                printf("2. Перекодирование строки - Сдвиг каждого символа в ASCII на заданное число\n");
                ...
                printf("7. Справка - Показать эту информацию\n");
